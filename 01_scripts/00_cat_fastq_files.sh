...
# parallel -a 02_infos/samples_list.txt -j 10 srun -p small -c 1 --mem=20G -J {}_00_cat_fasta_files -o log/00_cat_fasta_files_{}_%j.log 01_scripts/00_cat_fastq_files.sh {} &
