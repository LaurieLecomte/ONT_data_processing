...
# manitou
# parallel -a 02_infos/ind_ONT.txt -j 4 srun -p medium -c 4 --time=7-00:00 -J {}_02_winnowmap --mem=70G -o log/02_winnowmap_{}_%j.log 01_scripts/02_winnowmap.sh {} &

# valeria
# parallel -a 02_infos/ind_ONT.txt -j 4 srun -p ibis_medium -c 4 --time=7-00:00 -J {}_02_winnowmap --mem=70G -o log/02_winnowmap_{}_%j.log 01_scripts/02_winnowmap.sh {} &
...
# 2. Run winnowmap
winnowmap -t $CPU --MD --cs -W $ALIGNED_DIR/"$SAMPLE"_repetitive_k15.txt -ax map-ont $GENOME $FASTQ > $ALIGNED_DIR/"$SAMPLE".sam
